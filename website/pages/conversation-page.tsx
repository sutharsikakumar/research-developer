...
export default function ConversationPage() {
  ...
  return (
    <div className="bg-gray-50" style={{ height: 'calc(100vh - 74px)', marginTop: '74px' }}>
                      ...
                      <div className="max-w-[85%] p-4 rounded-2xl bg-white border border-gray-200 shadow-sm">
                        ...
                        <div className="space-y-3">
                          {pdfs.map((p) => (
                            ...
                            >
                              <div className="font-semibold text-gray-900 text-lg mb-1 break-words">
                                {p.split("/").pop()?.replace(/\.[^/.]+$/, "")}
                              </div>
                              <div className="text-base text-gray-500">PDF Document</div>
                            </button>
                          ))}
                        </div>
                      </div>
                              ...
                              return (
                                <div key={`${n}-${idx}`} className="border border-gray-200 rounded-xl p-4 hover:bg-gray-50 transition-colors">
                                  <div className="flex justify-between items-start gap-4">
                                    <div className="flex-1 text-lg text-gray-800 leading-relaxed break-words">
                                      {renderTextWithBold(line.slice(line.indexOf(".") + 1).trim())}
                                    </div>
                                    <button
                                      onClick={() => pickIdea(n)}
                                      className="px-6 py-2 bg-orange-500 text-white text-base font-semibold rounded-lg hover:bg-orange-600 transition-colors flex-shrink-0 shadow-sm hover:shadow-md"
                                    >
                                      Choose
                                    </button>
                                  </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 pr-16 text-lg bg-gray-50 text-gray-900 rounded-2xl border border-gray-200 outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-sm"
