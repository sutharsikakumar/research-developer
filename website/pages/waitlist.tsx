...
export default function WaitListPage() {
  ...
  if (done) {
    return (
      <div style={{
        minHeight: "100vh",
        background: "linear-gradient(135deg,rgb(255, 255, 255) 0%,rgb(248, 248, 248) 50%,rgb(240, 231, 226) 100%)",
        paddingTop: "80px",
        ...
        >
          ...
          >
            <p style={{ 
              ...
              Join the waitlist to get <span style={{ 
                color: "#ff6b35", 
                fontWeight: "600",
                background: "linear-gradient(135deg, #ff6b35, #ff8c42)",
                WebkitBackgroundClip: "text",
            ...
            <div style={{
              ...
              <p style={{
                ...
                How can we better understand the research landscape? What fields are connected? How can we find revolutionary solutions to these recurring problems? Unmeasured focuses on the uncharted territories of research, identifying gaps and opportunities that are often overlooked.
              </p>
              ...
              <p style={{
                ...
                <span style={{
                  color: "#ff6b35",
                  fontWeight: "600"
                }}>Trusted by students and researchers at</span> MIT, Duke, UNC, previous NCSEF and ISEF winners, and many more.
              </p>
            </div>
          </div>
        </div>
